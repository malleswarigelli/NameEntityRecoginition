...
class ModelPusher:
    def __init__(self, model_evaluation_artifact: ModelEvaluationArtifacts,
        model_pusher_config: ModelPusherConfig) -> None:
        """
        :param model_pusher_config: configuration for model pusher (obj of ModelPusherConfig class)
        :param model_evaluation_artifact: artifact of ModelEvaluation component
        """
        try:
    ...
    def initiate_model_pusher(self) -> ModelPusherArtifacts:
        try:
            ...
            if self.model_evaluation_artifact.is_model_accepted == True:
                ...
                logging.info("Model pushed to google container registry")
